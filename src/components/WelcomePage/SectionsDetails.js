...
export const entrySectionText = `Habit Tracker helps you learn the most effective process,
...
export const prioritySectionText = `When we don't set priorities, we tend to follow the path of least resistance.
